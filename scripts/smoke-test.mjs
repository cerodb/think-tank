...
// =========================================================================
// 6. loadPrompt() loads and substitutes variables
// =========================================================================
console.log("\n[6] loadPrompt() variable substitution");
...

{
  ...
  if (fileExists(".claude-plugin/plugin.json", "plugin.json exists")) {
    ...
    check(pj.version === "1.0.0", "plugin.json version is '1.0.0'");
    check(
...
// =========================================================================
// 8. Command files exist and reference orchestrator.mjs
// =========================================================================
console.log("\n[8] Command files");
...
// =========================================================================
// 9. All callClaude invocations use --no-session-persistence
// =========================================================================
console.log("\n[9] callClaude uses --no-session-persistence");
...
// =========================================================================
// 10. Orchestrator file structure
// =========================================================================
console.log("\n[10] Orchestrator structure");
